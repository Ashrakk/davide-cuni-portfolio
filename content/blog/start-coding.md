...
That’s a question that I made to myself when I was 9 years old. At that time I was playing Minecraft with a mod called “Computercraft”. That mod enabled me to write programs to automate aspects of the game, such as farming, mining or simply opening doors with a password, I took it as a game! And it was very fun. Every program was written in Lua programming language, very similar to Python.

That experience alone led me to learn more programming languages and frameworks, such as C#, C++, Forms in Visual Studio, Win32 Native Windows Applications, Direct X 9, Unity, Godot and web development.
...
Writing code with a purpose, and doing it for fun, made my passion for coding more robust, and I find it the best way to coding.

I found myself more committed to studying the subject and learning more about it to then use it for my own purposes, just like a set of tools that you can use to build anything.

## What is the secret to start coding?

Quite a lot of people have told me that they don’t know where to start from as many fear that they need to find someone or some institution to teach them coding. But i think it’s really much more simple than that.

The secret is to have fun by making silly projects and learning by practice. Think of it as a playground, imagine you’re a child and you have a certain set of toys but nobody tells you how to play with them, fueled by curiosity and exploring spirit you learn more about the toys and how they work. After that, creativeness and imagination come into play and you find yourself creating your own stories.
...
In the beginning theory comes second, as soon as you start you’re gonna find yourself researching how to do X and Y, but that’s exactly what programming is also about, a lot of research is involved. Then you will reach a point where you will know how to do stuff and the time put into researching decreases by a lot.

School and education certainly helps by teaching some of the basic theory concepts of software development like OOP (Object Oriented Programming) and algorithms, but it’s still up to you on how to use these informations, and you can learn a lot more about it while working on it than by just studying it.
